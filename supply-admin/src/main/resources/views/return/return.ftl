...
<form class="layui-form" style="margin: auto">
    ...
    <blockquote class="layui-elem-quote quoteBox">
        <fieldset class="layui-elem-field site-demo-button" style="margin: auto">
                ...
                <div class="layui-col-xs3">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="returnDate" id="returnDate" lay-verify="returnDate"
                               placeholder="yyyy-MM-dd" autocomplete="on" readonly="readonly"
                               class="layui-input">
                    </div>
                </div>
            </div>
