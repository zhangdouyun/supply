layui.use(['table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        id : "roleListTable",
        cols : [[
            {type: "checkbox", fixed:"left",sort:true, width:50,templet: function (d) {
                    return '<div style="text-align: left">'+d.checkbox+'</div>'
                }},
            {field: "id", title:'编号',fixed:"true",sort:true, width:80,templet: function (d) {
                    return '<div style="text-align: left">'+d.id+'</div>>'
                }},
            {field: 'name', title: '角色名', minWidth:50,sort:true, align:"center",templet:function (d) {
                    return '<div style="text-align: left">'+d.name+'</div>'
                }},
            {field: 'bz', title: '角色备注', minWidth:100,sort:true, align:'center',templet:function (d) {
                    return '<div style="text-align: left">'+d.bz+'</div>'
                }},
            {field: 'remarks', title: '描述', align:'center',sort:true,minWidth:150,templet:function (d) {
