layui.use(['element','table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'purchasingPrice', title: '采购价', minWidth:100, align:'center',templet:function (d) {
                    return '<div style="text-align: right">'+d.purchasingPrice+'</div>'
                }},
            {field: 'sellingPrice', title: '出售价', minWidth:100, align:'center',templet:function (d) {
                    return '<div style="text-align: right">'+d.sellingPrice+'</div>'
                }},
            {field: 'minNum', title: '库存下限', minWidth:100, align:'center',templet:function (d) {
                    return '<div style="text-align: right">'+d.minNum+'</div>'
                }},
