layui.use(['table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        cols : [[
            {type: "checkbox", fixed:"left", width:50,align: "center",templet: function (d) {
                    return '<div style="text-align: left">'+d.checkbox+'</div>'
                }},
            {field: "id", title:'编号',fixed:"true", width:80,align:"center",templet:function (d) {
                    return '<div style="text-align: left">'+d.id+'</div>'
                }},
            {field: 'name', title: '供应商', minWidth:50, align:"center",templet:function (d) {
                    return '<div style="text-align: left">'+d.name+'</div>'
                }},
            {field: 'contact', title: '联系人', minWidth:100, align:'center',templet:function (d) {
                    return '<div style="text-align: left">'+d.contact+'</div>'
                }},
            {field: 'number', title: '联系电话', align:'center',minWidth:150,templet:function (d) {
                    return '<div style="text-align: left">'+d.number+'</div>'
                }},
            {field: 'address', title: '联系地址', align:'center',minWidth:150,templet:function (d) {
